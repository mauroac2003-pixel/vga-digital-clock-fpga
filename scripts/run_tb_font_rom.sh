#!/bin/bash
# ============================================================
# Script: run_tb_font_rom.sh
# Descripción: Compila y ejecuta el testbench de ../sim/tb_font_rom
# Uso: cd sim/ && ./run_tb_font_rom.sh
# ============================================================
GREEN='\033[0;32m'
RED='\033[0;31m'
NC='\033[0m'
...
iverilog -o "$OUT_DIR/${TB_NAME}.out" \
         $RTL_DIR/font_rom.v \
         "$(dirname "$0")/../sim/tb_font_rom.v" 2>"$OUT_DIR/${TB_NAME}_compile.log"
