#!/bin/bash
# ============================================================
# Script: run_tb_vga_sync.sh
# Descripción: Compila y ejecuta el testbench de ../sim/tb_vga_sync
# Uso: cd sim/ && ./run_tb_vga_sync.sh
# ============================================================
GREEN='\033[0;32m'
RED='\033[0;31m'
NC='\033[0m'
...
iverilog -o "$OUT_DIR/${TB_NAME}.out" \
         $RTL_DIR/vga_sync.v \
         "$(dirname "$0")/../sim/tb_vga_sync.v" 2>"$OUT_DIR/${TB_NAME}_compile.log"
