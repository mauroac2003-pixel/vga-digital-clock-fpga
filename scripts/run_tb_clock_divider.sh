#!/bin/bash
# ============================================================
# Script: run_tb_clock_divider.sh
# Descripción: Compila y ejecuta el testbench de ../sim/tb_clock_divider
# Uso: cd sim/ && ./run_tb_clock_divider.sh
# ============================================================
GREEN='\033[0;32m'
RED='\033[0;31m'
NC='\033[0m'
...
iverilog -o "$OUT_DIR/${TB_NAME}.out" \
          \
         "$(dirname "$0")/../sim/tb_clock_divider.v" 2>"$OUT_DIR/${TB_NAME}_compile.log"
